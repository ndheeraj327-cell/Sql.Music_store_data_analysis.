...
--Moderate
--Q1: Write query to return the email, first name, last name, & Genre of all Rock Music listners,
...
--Return the Name and Milliseconds for eaxh track.
--Order by the song length wwith the longest songs isted first
...
--We determine the most popular genre as the genre with the highest amount of puchases.
